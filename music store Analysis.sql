...
one city that has the higest sum of invoice total return both the city name
...
Q.5: whois the best customer? the customer  who has spent the most money
will be declared the best cumstomer . write a query that retuns 
...
__________*___________*__________________*____________*____________*________________

SET 2 moderate question

Q1.: Write a query to return the email , first_name, last name & Genre of all rock
music listners. return your list ordered alphabetically by email starting with A.
...
Q2.let's invite the artists who have written the most rock music in our dataset . 
   write a query that retuns the artist name and total track count of top 10 
   rocks bands ?
